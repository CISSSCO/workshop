...
** run
#+begin_src bash :session openmpi :results output :exports both
sbatch script.sh ./hello1.out 4
#+end_src

#+RESULTS:
: Submitted batch job 1165884
...
#+begin_src bash :session openmpi :results output :exports both
sbatch script.sh ./p2p1.out 10
#+end_src

#+RESULTS:
: Submitted batch job 1165612
